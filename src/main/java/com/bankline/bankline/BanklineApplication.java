...
public class BanklineApplication {
	...
	private ApiInfoBuilder informacoesApi() {
		...
		apiInfoBuilder.title("API Bankline");
		apiInfoBuilder.description("Gama Academy - Projeto final: API - Bankline");
		apiInfoBuilder.version("1.0");
		apiInfoBuilder.termsOfServiceUrl("Termo de uso: Uso AccountBank");
		apiInfoBuilder.license("Free to use");
		apiInfoBuilder.licenseUrl("https://github.com/walterfjustino/bankline/");
	...
	private Contact contato() {
		...
		return new Contact("Burndown Team", "https://xpcorp.gama.academy/", "teste@gmail.com");
	}
